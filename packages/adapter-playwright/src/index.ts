 ...
 * `@svatah/yam-playwright-test`, which hosts it (LLD §1).
 */
export {
  PlaywrightSurface,
...
// The structural hash of LLD §6.2 lives in `@svatah/yam-surface`, where both an
// adapter and `@svatah/yam-bindings` can reach it (LLD §1). Re-exported so an adapter
// implementer needs one import.
export { structuralHash, renderForHash, lengthBucket } from "@svatah/yam-surface";
