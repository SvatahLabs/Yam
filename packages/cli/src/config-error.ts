 ...
 *
 * Defined in `@svatah/yam-bindings-cli` since Draft 2.5, because both command lines
 * read `yam.config.yaml` — module (a)'s `bindings verify`, `surface conform`
 ...
 * compiler.
 */
export { ConfigError } from "@svatah/yam-bindings-cli";
