/**
 * @svatah/yam-playwright-test — the `bind()` fixture (LLD §6.5, §9.2, module (a)).
 *
 ...
 * executor, is `@svatah/yam-host-playwright` in module (b) and re-exports `bind()`
 ...
 */
export { test, expect, HEALED_ANNOTATION, type YamFixtures, type YamOptions } from "./fixture.js";
export {
  Binder,
  modeFromEnvironment,
  type BindMode,
