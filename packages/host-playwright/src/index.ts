/**
 * @svatah/yam-host-playwright — the Playwright Test host for flows (LLD §9,
 * REQ-RUN-12, REQ-BEH-1, module (b)).
 *
 * A Yam flow is prose compiled to a plan. This runs that plan *inside*
 ...
 * trace viewer.
 *
 * It re-exports `bind()` from `@svatah/yam-playwright-test` (module (a)), so a
...
export { default as YamReporter, RESULTS_ATTACHMENT, type YamReporterOptions } from "./reporter.js";
 ...
 * `@svatah/yam-playwright-test`, which has no dependency on the executor.
 */
export {
  Binder,
  modeFromEnvironment,
  ...
  type BindOptions,
  type BindOutcome,
} from "@svatah/yam-playwright-test";
export { test as bindTest } from "@svatah/yam-playwright-test";
