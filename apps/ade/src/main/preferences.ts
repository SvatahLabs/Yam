/**
 * The only thing the ADE stores (T3.6, REQ-ADE-2, LLD §13.6).
 *
 * "No storage of its own beyond UI preferences. The project directory is the only
 * source of truth; anything the ADE shows is a file the CLI also reads or writes."
 *
 ...
 * time it disagreed with the files the ADE would be lying about the project.
 *
