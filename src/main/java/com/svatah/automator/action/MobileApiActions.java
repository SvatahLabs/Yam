 ...
 */
public class MobileApiActions implements Action<AppiumDriver, HttpActionMapper, ApiStepData> {

    @Override
    public ReturnType<?> perform(AppiumDriver driver, HttpActionMapper action, ApiStepData apiStepData)
        ...
        switch (action.getAction()) {
            case "INVOKE":
                try {
                    ...
                    if (responseBody != null && apiStepData.getOutputData() != null
                            && apiStepData.getOutputData().get() != null) {
