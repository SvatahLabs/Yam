...
Status: Draft 2.25 · Date: 2026-09-07 · Owner: Atul Sharma
Companion documents: [hld.md](hld.md) · [lld.md](lld.md) · [tasks.md](tasks.md) · [surface-first spec](surface-first/README.md)
...
| REQ-ADE-11 | The app is organised as a left rail with Surfaces (default), Automations, Activity and Settings navigation, a centre workspace and a right inspector, with a command palette on ⌘K; every one of the former eleven screens has exactly one home; surface control is directly reachable without visiting Automations or opening a project. The approved mockups under `docs/spec/design/` are the visual reference; supersedes the Flows-first rail of Draft 2.11 (Draft 2.25, SF-02, SF-16). | P1 | R, D |
