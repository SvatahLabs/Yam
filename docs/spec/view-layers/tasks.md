...
- [ ] **TV-T18 · P0 · Docs/evidence — Record the waves.** Requirements: TV-01..TV-19, all three layers. Refresh `pnpm ui:capture`, `docs/guides/use-the-app.md` and the generated package reference; write `progress/wave-*.md` with the evidence and the deviations. **Done:** the captures in the repository are of the cockpit that exists, and every requirement above is either evidenced or named as not met. Depends: TV-T17. A P2 left undone is recorded as undone; it does not hold the evidence.
